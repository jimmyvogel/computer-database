...
public class ComputerDaoTest extends JunitSuite {
    ...
    @Autowired
    private static CompanyCrudDao daoCompany;
    @Autowired
    private static ComputerCrudDao dao;
...
//        CDBPage<Computer> page = dao.getPage(1);
...
//        }
//        CDBPage<Computer> page = dao.getPageSearch(search, 1);
