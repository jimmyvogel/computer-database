...
public interface ComputerCrudDao extends PagingAndSortingRepository<Computer, Long> {
	...
	Page<Computer> findByNameContainingOrCompanyNameContainingOrderByNameDesc(String name, String companyName, Pageable p);
	Page<Computer> findByNameContainingOrCompanyNameContainingOrderByIntroducedAsc(String name, String companyName, Pageable p);
	Page<Computer> findByNameContainingOrCompanyNameContainingOrderByIntroducedDesc(String name, String companyName, Pageable p);
	Page<Computer> findByNameContainingOrCompanyNameContainingOrderByDiscontinuedAsc(String name, String companyName, Pageable p);
	Page<Computer> findByNameContainingOrCompanyNameContainingOrderByDiscontinuedDesc(String name, String companyName, Pageable p);
